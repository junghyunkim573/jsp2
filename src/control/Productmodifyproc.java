...
@WebServlet("/Productmodifyproc.do")
@MultipartConfig(
      fileSizeThreshold=0,
      location="E:\\jsp\\lupang\\WebContent\\upload"
)
public class Productmodifyproc extends HttpServlet {
   private static final long serialVersionUID = 1L;       
    
    public Productmodifyproc() {
        super();        
    }   
   ...
   protected void doAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         System.out.println(request.getParameter("delivery"));
         System.out.println(request.getParameter("amount"));
         System.out.println(request.getParameter("delivery_company"));
         System.out.println(request.getParameter("company"));
         ...
         pro.setUid(Integer.parseInt(request.getParameter("uid")));
