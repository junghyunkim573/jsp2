...
@WebServlet("/Orderbylistbusy.do")
public class Orderbylistbusy extends HttpServlet {
   private static final long serialVersionUID = 1L;
       
    
    public Orderbylistbusy() {
        super();
   ...
   protected void doAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      RequestDispatcher dis=request.getRequestDispatcher("/admin/orderbylistbusy.jsp");
