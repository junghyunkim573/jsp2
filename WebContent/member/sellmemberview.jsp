...
<%@ include file="../head.jsp" %>
       <div class="container2">
           <form action="${home}/SellMemberModify.do?email=${user.email }" method="post" enctype="multipart/form-data" >
            ...
            <div class="sell_join_box">
                <span class="sell_join_title" >
                 <label for="userID">아이디(email)</label>              
                  ...
                  <span class="sell_join_input_box">  
                   <input type="text" class="sell_join_input" placeholder="ex) lupang@google.com" autofocus id="userID" name="id" readonly value="${user.email}" >             
                </span>            
            </div>
             ...
             <div class="sell_join_box">
                ...
                <span class="sell_join_input_box">     
                   <input type="text" class="sell_join_input" placeholder="숫자,영문,특수문자 최소 2개 조합하여 4~16자리" id="userPW" readonly  value="${user.pass}" name="pass" >             
                 </span>
            </div>
             <div class="sell_join_box">
                <span class="sell_join_title" >
                ...
                <span class="sell_join_input_box">     
                   <input type="text" class="sell_join_input" placeholder="비밀번호 확인!" readonly  value="${user.pass}" id="userPW" name="pass2" >             
                 </span>
            </div>
             <div class="sell_join_box">
                <span class="sell_join_title" >
                ...
                <span class="sell_join_input_box">   
                   <input  class="sell_join_input" placeholder="ex)홍길동" id="userName" readonly name="name"  value="${user.name}">             
                </span>
            </div>
             <div class="sell_join_box">
                <span class="sell_join_title" >
                 <label for="phone">연락처</label>           
                  ...
                  <select name="mobile1" class="sell_join_select">
                   ...
                   <input class="sell_input_phone" placeholder="- 제외한 뒷자리ex)32541524" id="phone" readonly name="mobile2" value="${user.mobile2}" >             
            </div>
            <div class="sell_join_box">
                <span class="sell_join_title" >
                 <label for="account">통장 번호</label>           
                  ...
                  <select name="account1" class="sell_join_select">
                   ...
                   <input class="sell_input_phone" placeholder="- 제외한 통장번호" id="account" name="account2" readonly value="${user.account2}" >             
            </div>

                        
           
             <div class="login_box_submit">
                 <button type="submit" value="로그인" class="login_button">회원 수정 하러가기</button>
            </div>
            </form>
            <div class="login_box_submit">
