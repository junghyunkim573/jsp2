    ...
    <div class="height_purchase"></div>
       ...
       <br>
         ...
         <div class="qna_title3">
                <span class="qna_input4"><a href="${home }/Qnalist.do">[목록]</a></span>
                <span class="qna_input5"><a href="${home }/Qnareply.do?uid=${view.uid}">[답변]</a></span>
                <c:if test="${view.email == session_email}"> 
                <span class="qna_input5"><a href="${home }/Qnamodify.do?uid=${view.uid}">[수정]</a></span>
                <span class="qna_input5"><a href="${home }/Qnadel.do?uid=${view.uid}">[삭제]</a></span>   
                </c:if>
                <c:if test="${view.email != session_email}">
